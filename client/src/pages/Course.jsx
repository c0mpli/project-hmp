              ...
              <div className="courseWrapper">
                ...
                <div className="courseProgressWrapper">
                  <div style={{ display: "flex", gap: "3px" }}>
                    <h4>Total Duration: {course.duration} weeks</h4>
                    <h4 style={{ color: "#FFB800" }}>
                      ({course.duration * 7} days)
                    </h4>
                  </div>
                  <div style={{ display: "flex", gap: "3px" }}>
                    <h4>Current Progress: {courseWeek} weeks </h4>
                    <h4 style={{ color: "#FFB800" }}>({courseDay} days)</h4>
                  </div>
                </div>
                <div className="courseInputWrapper">
                  ...
                  <div className="selectWrapper">
                    ...
                    <select
                      value={courseDay}
                      onChange={(event) => {
                        setCourseDay(parseInt(event.target.value, 10));
                      }}
                    >
