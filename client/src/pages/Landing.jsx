...
function Landing() {
  ...
  useEffect(() => {
    if (width < 552) setProgramCount(1);
    else if (width >= 552 && width < 821) setProgramCount(2);
      ...
      <div className="landing">
        ...
        <div className="landing-aboutus" ref={aboutusRef}>
          ...
          <p>
            ...
            Access elite level fitness and rehab programs designed by Sports
            Physiotherapist Heath Matthews, for independent training and
            recovery or book a consultation. We aim to optimise mobility,
            strength and flexibility to bridge the gap between rehab and
            fitness.
          </p>
        ...
        <div className="landing-services">
          <div className="servicesContent">
            <h1>
              Services Available <img src={approveBadge} alt="Approved Icon" />
            </h1>
            <div className="servicesWrapper">
              <ServiceCard
                title="Physiotherapy"
                message="Relax, unwind and let our therapists work the tension away."
                side="left"
                image={therapyBadge}
              />
              <ServiceCard
