...
function ManageDoctor() {
  ...
  useEffect(() => {
    axios
      .get("https://docwebsite.adityasurve1.repl.co/admin/gethealthpartners", {
  ...
  function handleDelete(key) {
    ...
    axios
      .post(
        "https://docwebsite.adityasurve1.repl.co/admin/deletehealthp",
        {
          _id: doctors[key]._id,
        },
        { headers: { token: localStorage.getItem("token") } }
  ...
  function handleSubmit(e) {
    ...
    axios
      .post(
        "https://docwebsite.adityasurve1.repl.co/admin/addhealthp",
        {
          email: email,
          password: password,
          firstname: split[0],
