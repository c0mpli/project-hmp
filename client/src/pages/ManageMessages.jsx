...
function ManageMessages() {
  ...
  axios
    .get("https://docwebsite.adityasurve1.repl.co/sadmin/getmessages", {
  ...
  function handleDelete(key) {
    axios
      .post(
        "https://docwebsite.adityasurve1.repl.co/sadmin/deletemessage",
        {
  ...
  function handleSend() {
    axios
      .post(
        "https://docwebsite.adityasurve1.repl.co/sadmin/broadcastmsg",
        {
